...
from consolebot.query import determine_repo_name, generate_combinations, data, get_language,get_recent_activity, get_contributors, get_wordnet_pos, preprocess_text, determine_intent, get_summary, generate_combinations, disambiguate_repo_name
import itertools
import spacy
import json
...
class TestGetSummary(unittest.TestCase):
    ...
    @patch('consolebot.query.data', {"TestRepo": {"readme": "", "description": "A test repo."}})
    def test_repo_without_readme(self):
        summary = get_summary("TestRepo")
        self.assertEqual(summary, "No summary available.")

    @patch('consolebot.query.data', {})
...
class TestRepoMethods(unittest.TestCase):
    ...
    @patch('consolebot.query.data', mock_data)
